...
OUT_VIDEO = "STRUMER_I_Structural_Cinema_v1_11.mp4"
OUT_POSTER = "STRUMER_I_Structural_Cinema_Poster_v1_11.png"
OUT_VERIFY = "STRUMER_I_Structural_Cinema_VERIFY_v1_11.txt"
...
def slide_1(t):
    ...
    draw = ImageDraw.Draw(img)
    title(draw, "STRUCTURAL IMAGE RESOLUTION", "One small image change restarts the work.", 64)
    ...
    punch(draw, "Why rebuild images from scratch when structure can evolve?", 650, ACCENT)
...
def write_verify(total):
    ...
    with open(OUT_VERIFY, "w", encoding="utf-8") as f:
        f.write("STRUMER-I Structural Cinema v1.11 VERIFY\n")
...
def main():
    ...
    print("STRUMER-I Structural Cinema v1.11")
